...
const Introduction = () => {
  return (
    ...
    >
      ...
      <div className="w-full lg:w-3/5 flex justify-items-center items-center px-6 xl:px-12 py-10 lg:py-0">
        <div className="space-y-10 max-h-[80vh] overflow-y-auto scroll-smooth md:space-y-12">
          <div className="justify-items-center lg:text-left md:space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:gap-4">
              <h2 className="text-3xl md:text-4xl lg:text-5xl text-gray 2xl:text-7xl">
                es mi verdadera
              </h2>
          ...
          <div className="space-y-8">
            <p className="text-lg md:text-xl text-whitelight font-Baskerville text-justify">
